...
async function bootstrap() {
  ...
  const port = AppConfiguration.CART_SERVICE_PORT || 3007;

  app.connectMicroservice(GrpcServerOptions(GrpcService.CART_SERVICE));
  app.connectMicroservice(KafkaServerOptions(QueueGroups.CART_GROUP));
